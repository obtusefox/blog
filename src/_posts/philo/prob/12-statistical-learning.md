...
즉, 실제 데이터의 상대적인 빈도수는 변화하는 확률의 평균에 수렴하지, 실제 확률로 수렴하지 않는다. 예를 들어, 실제 지진의 확률이 1/2와 1/3 사이를 왔다갔다 하고 있다고 한다. 그럼 홀수의 경우 1/2이고, 다음 경우 실제로는 1/3이 될 것이다. 그럼 장기적으로는 5/12가 될 것이다. 그러나 사실 1/2나 1/3이어야 한다.
