<template>
  <div class="home-blog" :class="recoShow?'component-show': 'component-hide'">
    ...
    <div class="home-blog-wrapper">
      ...
      <div class="info-wrapper">
         ...
         <hr>
         <h4><i class="iconfont component-category"></i> 分类</h4>
        ...
        <hr>
        <h4><i class="iconfont component-tag"></i> 标签</h4>
        <div class="tags">
          <span 
