<template>
  <div>
    <i
      class="iconfont component-account"
    ...
    <i class="iconfont component-date" v-if="pageInfo.frontmatter.date"><span>{{ new Date(pageInfo.frontmatter.date).toLocaleDateString() }}</span></i>
    <AccessNumber :idVal="pageInfo.path" :numStyle="numStyle"></AccessNumber>
    <i class="iconfont component-tag tags" v-if="pageInfo.frontmatter.tags">
      <span
